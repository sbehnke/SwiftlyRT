...
//    func testProjectile() {
//
////        let p = Projectile(position: Vector4(x: 0, y: 1, z: 0, w: 1.0), velocity: Vector4.normalize(rhs: Vector4(x: 1, y: 1, z: 0, w: 0)))
////        let environment = Environment(gravity: Vector4(x: 0, y: -0.1, z: 0, w: 0.0), wind: Vector4(x: -0.01, y: 0, z: 0, w: 0.0))
////
